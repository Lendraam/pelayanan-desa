...
export default function Usaha() {
  ...
  const syarat = [
    { label: "Nama Pemilik Usaha", name: "nama_pemilik_usaha", type: "text" },
    { label: "Alamat Usaha", name: "alamat_usaha", type: "text" },
    { label: "Tujuan Pembuatan Surat (Untuk Apa?)", name: "tujuan_pembuatan", type: "text" },
    { label: "Foto Usaha", name: "foto_usaha", type: "file" },
  ];
  ...
  if (submitted) {
    return (
      <div className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8 text-center">
        ...
        <p className="text-gray-700">Data pengajuan Surat Keterangan Usaha telah dikirim.</p>
      </div>
    );
  }
  ...
  return (
    <section className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8">
      <h1 className="text-2xl font-bold text-green-700 mb-6 text-center">Form Surat Keterangan Usaha</h1>
