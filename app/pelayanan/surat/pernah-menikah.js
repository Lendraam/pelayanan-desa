...
export default function PernahMenikah() {
  ...
  if (submitted) {
    return (
      <div className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8 text-center">
        ...
        <p className="text-gray-700">Data pengajuan Surat Keterangan Pernah Menikah telah dikirim.</p>
      </div>
    );
  }
  ...
  return (
    <section className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8">
      <h1 className="text-2xl font-bold text-green-700 mb-6 text-center">Form Surat Keterangan Pernah Menikah</h1>
