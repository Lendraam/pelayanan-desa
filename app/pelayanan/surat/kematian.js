...
export default function Kematian() {
  ...
  const syarat = [
    { label: "KTP Pelapor", name: "ktp_pelapor", type: "file" },
    { label: "KTP Almarhum", name: "ktp_almarhum", type: "file" },
    { label: "Tanggal Meninggal", name: "tanggal_meninggal", type: "date" },
    { label: "Alamat", name: "alamat", type: "text" },
    { label: "Tanggal Lahir Almarhum", name: "tanggal_lahir_almarhum", type: "date" },
    { label: "Jam Meninggal", name: "jam_meninggal", type: "time" },
  ];
  ...
  if (submitted) {
    return (
      <div className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8 text-center">
        ...
        <p className="text-gray-700">Data pengajuan Surat Keterangan Kematian telah dikirim.</p>
      </div>
    );
  }
  ...
  return (
    <section className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8">
      <h1 className="text-2xl font-bold text-green-700 mb-6 text-center">Form Surat Keterangan Kematian</h1>
