...
export default function Domisili() {
  ...
  const syarat = [
    ...
    { label: "Alamat Domisili", name: "alamat_domisili", type: "text" },
  ...
  if (submitted) {
    return (
      <div className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8 text-center">
        ...
        <p className="text-gray-700">Data pengajuan Surat Keterangan Domisili telah dikirim.</p>
      </div>
    );
  }
  ...
  return (
    <section className="max-w-lg mx-auto bg-white rounded-xl shadow p-8 mt-8">
      <h1 className="text-2xl font-bold text-green-700 mb-6 text-center">Form Surat Keterangan Domisili</h1>
